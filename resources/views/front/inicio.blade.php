...
================================================== -->
  <body>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <a class="left carousel-control" href="{{ url('/') }}" role="button" data-slide="prev">
        <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
      </a>
      <a class="right carousel-control" href="{{ route('nosotros') }}" role="button" data-slide="next">
...
Destinamos una sección dentro de nuestro sitio web para dar todos los detalles sobre el tema de Fiscalización.</p>
        {{-- <p><a class="btn btn-primary btn-lg" href="https://www.ine.mx/voto-y-elecciones/fiscalizacion/" role="button">Saber mas »</a></p> --}}
      </div>
    </div>
