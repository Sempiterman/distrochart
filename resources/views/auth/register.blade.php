...
<div class="container">
        <div class="col-md-7">
          <h2 class="featurette-heading">Registrate.</h2>
          <p class="lead">Si ya formas parte del equipo del INE de la junta distrital 06 solicita tu contrasena y usuario con el departamento de recursos humanos de capacitacion.</p>
        </div>
        <div class="col-md-5">
