        ...
        <nav class="navbar navbar-inverse navbar-static-top ">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><code>INE</code></a>
            </div>
        ...
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="<?php echo e(route('inicio')); ?>" role="button">Leer mas.</a></p>
            </div>
          </div>
        </div>
        ...
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="<?php echo e(route('nosotros')); ?>" role="button">Leer mas.</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="<?php echo e(route('contactos')); ?>" role="button">Ver mas.</a></p>
            </div>
          </div>
        </div>
      </div>
...
<p class="lead">Aun no has tramitado tu credencial de elector? Puedes acudir a oficinas ve nuestra seccion de <a href="<?php echo e(route('contactos')); ?>"><code>contactos</code></a>.</p>
        </div>
