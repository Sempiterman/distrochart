        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php echo Form::model($kit, ['route' => ['equipos.update', $kit->id], 'method' => 'PUT', 'files' => true]); ?>

                        
                        <?php echo $__env->make('documentos.equipos.partials.update', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
